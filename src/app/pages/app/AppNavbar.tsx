        ...
        relative inset-x-0 top-0 z-30 mx-auto w-full border-gray-300 max-w-3xl rounded-xl">
           <HStack justify={'space-between'}>
                ...
                <Menubar className='bg-transparent border-transparent'>
                    <MenubarMenu>
                        <MenubarTrigger className={menuTriggerStyle}>File</MenubarTrigger>
                    ...
                    <MenubarMenu>
                        <MenubarTrigger className={menuTriggerStyle}>View</MenubarTrigger>
                        <MenubarContent className='dark:bg-black mt-2'>
                    ...
                    <MenubarMenu>
                        <MenubarTrigger className={menuTriggerStyle}>Preference</MenubarTrigger>
                        <MenubarContent className='dark:bg-black mt-2'>
                            <MenubarSub>
